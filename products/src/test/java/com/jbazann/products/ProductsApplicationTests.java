...
import static com.jbazann.products.product.testdata.ProductDataset.*;
...
class ProductsApplicationTests {
	...
	void clearPostgresData() {
		...
		resetData();
		productsRepository.saveAll(PERSISTED_PRODUCTS);
	}

	@Test
	void createProduct() {
		NewProductDTO dto = CREATE_PRODUCT.entry().asNewProductDTO();
		ProductDTO result = CREATE_PRODUCT.entry().asProductDTO();
	...
	@Test
	void deleteProduct() {
		ProductDTO dto = PERSISTED.entry().asProductDTO();
